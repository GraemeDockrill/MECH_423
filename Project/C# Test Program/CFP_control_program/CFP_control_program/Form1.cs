...
namespace CFP_control_program
{
    public partial class Form1 : Form
    {
        ...
        private void chkByte8_CheckedChanged(object sender, EventArgs e)
        {
            if (chkByte8.Checked == true)
                txtByte8.Enabled = true;
            else
            {
                txtByte8.Clear();
        ...
        private void chkByte9_CheckedChanged(object sender, EventArgs e)
        {
            if (chkByte9.Checked == true)
                txtByte9.Enabled = true;
            else
            {
                txtByte9.Clear();
        ...
        private void btnTransmitToComPort_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (serialPort1.IsOpen)
                {
                    ...
                    if (chkByte8.Checked && (txtByte8.Text != ""))
                    {
                        TxBytes[7] = Convert.ToByte(txtByte8.Text);
                        serialPort1.Write(TxBytes, 7, 1);
                    }
                    if (chkByte9.Checked && (txtByte9.Text != ""))
                    {
